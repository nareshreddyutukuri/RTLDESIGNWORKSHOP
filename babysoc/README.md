...
> Upload this `README.md` together with the `images/` folder to the root
> of your GitHub repo — the image links below are relative paths and will
...
![Yosys design stats](images/01_yosys_stats_vsdbabysoc.jpeg)
...
![clk_gate and rvmyth netlist](images/02_clk_gate_rvmyth_netlist.jpeg)
...
![GTKWave pre vs post synth](images/03_gtkwave_pre_vs_post_synth.jpeg)
...
![baby_soc_netlist.v in Mousepad](images/04_baby_soc_netlist_mousepad.jpeg)
...
![Yosys stat and check pass](images/05_yosys_check_pass_stats.jpeg)
...
![DFF legalize mapping](images/06_dfflegalize_mapping.jpeg)
...
![GTKWave pre vs post synth v2](images/07_gtkwave_pre_vs_post_synth_v2.jpeg)
...
![ABC synthesis results](images/08_abc_results_synthesis.jpeg)
...
![Yosys opt passes](images/09_yosys_opt_passes.jpeg)
...
![Two netlist files in Mousepad](images/10_netlist_files_mousepad_tabs.jpeg)
...
![Final netlist with sky130 cells](images/11_netlist_sky130_cells.jpeg)
...
![Terminal cell reference counts](images/12_terminal_cell_reference_counts.jpeg)
...
![testbench.v in Mousepad](images/13_testbench_mousepad.jpeg)
